...
with st.form("match_form"):
    ...
    with col1:
        ...
        goalie_home = st.number_input("Goalie Home", 0.0, 1.0, 0.5, step=0.01)
    ...
    with col2:
        ...
        goalie_away = st.number_input("Goalie Away", 0.0, 1.0, 0.5, step=0.01)

    calculate = st.form_submit_button("Spočítat")
...
if calculate:
    ...
    st.metric("P(výhry)", f"{p_win*100:.1f} %")
